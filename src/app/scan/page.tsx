...
export default function ScanPage() {
  ...
  const handleScan = async (data: ScanInput) => {
    ...
    const totalSources = 1 + activeProviders.length; // 1 for free XposedOrNot
        ...
        return fetch('/api/providers', {
          ...
          .then(async (res) => {
            ...
            if (res.ok && result.breaches && result.breaches.length > 0) {
              // Convert provider breach format to Finding format
  ...
  // Deduplicate findings by normalized source name
